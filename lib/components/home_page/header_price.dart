...
class HeaderPrice extends StatefulComponent {
  const HeaderPrice({super.key});

  @override
  State<HeaderPrice> createState() => HeaderPriceState();
}

class HeaderPriceState extends State<HeaderPrice> {
