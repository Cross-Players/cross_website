...
class CareerView extends StatefulComponent {
  const CareerView({required this.jobs, this.errorMessage, super.key});

  final List<Map<String, String>> jobs;
  final String? errorMessage;

  @override
  State createState() => CareerViewState();
...
class CareerViewState extends State<CareerView> {
                    ...
                    [
                      ...
                      if (component.errorMessage != null)
                        div(
                            ...
                            [
                              p([Component.text(component.errorMessage!)])
                            ]),

                      if (component.errorMessage == null)
                        ...component.jobs.map((job) => div(
                                styles: Styles(
                                  display: Display.flex,
                                  width: 100.percent,
                                  padding: const Spacing.all(Unit.pixels(16)),
                                ...
                                [
                                  ...
                                  div(
                                      ...
                                      [
                                        p([
                                          Component.text(job['deadlineTime']!)
                                        ])
                                      ]),
                                ])),
                    ]),
    ...
    return section(classes: 'hero', [
      div(classes: 'container', [
        h1(classes: 'hero-title', [
          Component.text(
              LanguageManager.translate('career_title', selectedLang))
        ]),
      ]),
    ]);
  }
                    ...
                    [
                      ...
                      div(
                          ...
                          [
                            ...
                            a(
                                ...
                                [Component.text('crosstechedu@gmail.com')])
                          ]),
                      ...
                      div([
                        ...
                        a(
                            ...
                            [Component.text('0338305895 - Mr. Quyen Anh')])
                      ])
                    ])
              ])
        ]);
