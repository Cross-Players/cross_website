                  ...
                  ...jobs.map(
                    (job) => div(
                      styles: Styles(
                        ...
                        width: 100.percent,
                        padding: const Spacing.all(Unit.pixels(16)),
                        margin: const Spacing.only(bottom: Unit.pixels(1)),
                      ...
                      [
                        ...
                        div(
                          ...
                          id: 'salary',
                          [
                            p([Component.text(job.salary + ' triệu VND')])
                          ],
                        ),
                        div(
                          classes: 'career-table-item',
                          id: 'deadline',
                          [
                            p([Component.text(job.deadlineTime)])
                          ],
                        ),
                      ],
                    ),
              ...
              [
                div(
                  ...
                  [
                    p(
                      styles: Styles(
                        margin: const Spacing.only(bottom: Unit.pixels(8)),
                        color: Colors.black,
                        fontSize: 18.px,
                      ),
                      [
